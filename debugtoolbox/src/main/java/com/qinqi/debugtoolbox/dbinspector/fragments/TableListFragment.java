...
import com.qinqi.debugtoolbox.dbinspector.cache.InMemoryFileDescriptorCache;
import com.qinqi.debugtoolbox.dbinspector.helpers.DatabaseHelper;
import com.qinqi.debugtoolbox.dbinspector.services.CopyDbIntentService;
import com.qinqi.debugtoolbox.dbinspector.services.ImportDbIntentService;
...
public class TableListFragment extends ListFragment {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        inflater.inflate(R.menu.menu_dbinspector_frag_table_list, menu);

    }

    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.dbinspector_action_share) {
