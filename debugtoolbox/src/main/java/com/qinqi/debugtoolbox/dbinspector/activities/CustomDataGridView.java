...
public class CustomDataGridView extends View {
    ...
    private void drawData(Canvas canvas, int startPosX, int startPosY){
        ...
        //Logger.i("drawData", "startPosX:"+startPosX+" posX:"+posX);
        //Logger.i("drawData","startPosY:"+startPosY + " PosY:"+ posY + " itemHeight:"+itemHeight);
        //Logger.i("drawData", "rows:"+ mData.size() +  " startRow:"+startRow + " endRow:"+ endRow);
...
//            Logger.i("drawData", "posX:"+ posX+" index:"+index+" containWidth:"+containWidth);
            return true;
